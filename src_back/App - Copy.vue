<template>
    ...
    <div class="container">
        ...
        <button
        type="submit"
        @click="calculateMultipleDays(this.selectedDates, this.selectedPeriodType, this.selectedDays)"
    >
...
export default {
    name: "App",
    component: { DatepickerComponent, CalendarComponent },
    props: {},
    // data() {
    //     return {
    //         period: 1,
    ...
    //                 defaultEnd = new Date(new Date(this.currentYear, this.currentMonth + 1, this.currentDate).toDateString());
    //                 console.log("day: ", defaultEnd);

    //                 this.endDate = defaultEnd.toISOString();
    //                 this.selectedPeriodType = event.target.value;

    //                 break;
    //             case "week":

    //                 defaultEnd = new Date(new Date(this.currentYear, this.currentMonth + 3, this.currentDate - 1).toDateString());
    ...
    //                 defaultEnd = new Date(new Date(this.currentYear + 1, this.currentMonth, this.currentDate).toDateString());
    ...
    //                 defaultEnd = new Date(new Date(this.currentYear + 5, this.currentMonth + 1, this.currentDate).toDateString());
    ...
    //         this.endDate = new Date(new Date(this.currentYear, this.currentMonth + 1, this.currentDate).toDateString()).toISOString();
    //     }
    // },
}
</script>
